                    ...
                    <c:forEach items="${coffeeList}" var="coffee">
                        <div class="col-sm-6 col-md-4">
                            <div class="thumbnail">
                                ...
                                <img src="${pageContext.request.contextPath}/static/images/${coffee.image}" class="img-responsive">
                                <div class="caption">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-6">
                                            <h3><a href="${pageContext.request.contextPath}/cart/product/${coffee.id}" class="btn btn-success btn-product"><span
